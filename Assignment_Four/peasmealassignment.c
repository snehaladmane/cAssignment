...
int main(void)
{
    ...
    printf("1st Elements Of Array 'iArrayOne[]' or Elements At 0th Index Of Array 'iArrayOne[]' = %d\n", iArrayOne[0]);
    printf("2nd Element Of Array 'iArrayOne[]' or Element At 1nd Index Of Array 'iArrayOne[]' = %d\n", iArrayOne[1]);
    printf("3rd Element Of Array 'iArrayOne[]' Or Element At 2rd Index Of Array 'iArrayOne[]' = %d\n", iArrayOne[2]);
    printf("4rd Element Of Array 'iArrayOne[]' Or Element At 3rd Index Of Array 'iArrayOne[]' = %d\n", iArrayOne[3]");
    ...
    scanf("%d", &iArrayTwo[2]);
    printf("Enter 4th Element of Arry'iArrayTwo[]' : ");
    scanf("%d", &iArrayTwo[3]);
