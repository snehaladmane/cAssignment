...
int main(void)
{
    // *** LOCAL SCOPE OF main()BEINGS ***
    //variable declarations
    //'a' is a local Variable. It is loacl to main() only.
    int a = 5;
    ...
    //Since, 'local_count' is an ordinary local variable of change_count()' it will NOT retain its value from previos call to change_count().
